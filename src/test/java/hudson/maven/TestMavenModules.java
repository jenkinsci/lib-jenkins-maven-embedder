...
public class TestMavenModules extends TestCase {
    ...
    public void testModuleWithAPomInTheSameDirWithMaven2() throws Exception {
        ...
        MavenProject root =
                mavenEmbedder.readProject(new File("src/test/projects-tests/several-modules-in-directory/pom.xml"));
    ...
    public void testModuleWithAPomInTheSameDirWithMaven3() throws Exception {
        ...
        List<MavenProject> projects = mavenEmbedder.readProjects(
                new File("src/test/projects-tests/several-modules-in-directory/pom.xml"), true);
